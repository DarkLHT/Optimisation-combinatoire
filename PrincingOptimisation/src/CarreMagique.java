...
public class CarreMagique {
	...
	IntVar[][] lignes = VariableFactory.boundedMatrix("x", n, n, 1, n * n, solver);
	...
	switch(heuristique) {
		...
		solver.set(IntStrategyFactory.activity(toutesLesVariables, 42));
		break;
	}
	...
	switch(restart) {
		...
		SearchMonitorFactory.geometrical(solver, 2, 2.1, new FailCounter(2), 25000);
		break;
	}
